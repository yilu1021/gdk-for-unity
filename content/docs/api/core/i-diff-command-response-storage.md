...
<table width="100%">
    ...
    <tr>
        <td colspan="2">
<code><a href="{{.Site.BaseURL}}/api/core/received-messages-span">ReceivedMessagesSpan</a>&lt;T&gt; GetResponses()</code></p>
...
<table width="100%">
    ...
    <tr>
        <td colspan="2">
<code><a href="{{.Site.BaseURL}}/api/core/received-messages-span">ReceivedMessagesSpan</a>&lt;T&gt; GetResponse(long requestId)</code></p>
